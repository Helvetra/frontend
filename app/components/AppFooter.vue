      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="flex flex-col md:flex-row items-center gap-4 md:gap-8">
          ...
          <nav class="flex gap-6 text-sm">
            ...
            <NuxtLink :to="localePath('/news')" class="text-neutral-500 hover:text-neutral-900 transition-colors">
              {{ $t('nav.news') }}
            </NuxtLink>
        ...
        <div class="flex items-center gap-4">
          ...
          <!-- Instagram -->
          <a
            href="https://instagram.com/helvetra.ch"
            target="_blank"
            rel="noopener"
            class="text-neutral-400 hover:text-neutral-900 transition-colors"
          ...
          <!-- LinkedIn -->
          <a
            href="https://www.linkedin.com/company/helvetra/"
            target="_blank"
            rel="noopener"
            class="text-neutral-400 hover:text-neutral-900 transition-colors"
            aria-label="LinkedIn"
